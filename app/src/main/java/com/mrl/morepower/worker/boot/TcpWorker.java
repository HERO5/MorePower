...
import com.mrl.morepower.worker.handler.WorkerHandler;
import com.mrl.netty.common.parse.MessageDecoder;
import com.mrl.netty.common.parse.MessageEncoder;
...
public class TcpWorker {
    ...
    public TcpWorker(Handler handler, String host, int port) {
        this.host = host;
        this.port = port;
        init(handler);
    }
                ...
                .handler(new ChannelInitializer<SocketChannel>(){
                    ...
                    protected void initChannel(SocketChannel ch) throws Exception {
                        ...
                        pipeline.addLast(new IdleStateHandler(0,4,0, TimeUnit.SECONDS))
                                ...
                                .addLast(new WorkerHandler(handler));
                    }
                });
    }
